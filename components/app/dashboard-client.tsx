...
export function DashboardClient() {
  const handleExport = useCallback(() => {
    console.log("[txostenak] esportatu egoera");
  }, []);

  return (
    <div className="dashboard-stack">
      <Section actions={<Badge tone="neutral">Demo fasea</Badge>} desc="Egungo egoeraren laburpena eta erantzun azkarra" title="Hasiera-panela">
